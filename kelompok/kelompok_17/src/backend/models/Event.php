...
class Event
{
    ...
    public function create(array $data): int
    {
        $sql = "INSERT INTO {$this->table} 
                (title, description, banner, event_date, start_time, end_time, location, status, created_by, created_at) 
                VALUES (:title, :description, :banner, :event_date, :start_time, :end_time, :location, :status, :created_by, NOW())";
    ...
    public function update(int $id, array $data): bool
    {
        ...
        $allowedFields = ['title', 'description', 'banner', 'event_date', 'start_time', 'end_time', 'location', 'status'];
